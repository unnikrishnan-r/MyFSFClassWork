...
function displayResults(data) {
  ...
  data.forEach(element => {
    // $("#animal-name").val(element.name);
    $("#results")
      .find("tbody")
      .append($("<tr>")
      .append($("<td>").append($("<p>").text(element.name)))
      .append($("<td>").append($("<p>").text(element.numLegs)))
      .append($("<td>").append($("<p>").text(element.class)))
      .append($("<td>").append($("<p>").text(element.weight)))
      .append($("<td>").append($("<p>").text(element.whatIWouldReallyCallIt)))
      );
      ;
  });
}
